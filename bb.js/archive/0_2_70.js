...
bb.pressDate="23:41 2011/1/8"	// 当前版本的发布时间
bb.version	="0.2.70";		// 当前库的版本
...
if(isFunction(document.onreadystatechange)){
	setOnDomReady(document.onreadystatechange);
}
document.onreadystatechange=function(event){
	for(var i=0,length=onDomReadyHandel.length;i<length;i++){
		onDomReadyHandel[i](event);
		document.onreadystatechange=[];	// IE会执行两次？
	}
}
/* 
